...
class ManifestNode{
    ...
    public function __sleep(){
        $t = array_diff(array_keys(get_class_vars("BoA\Core\Xml\ManifestNode")), array("_accessDriver", "_repository", "_metaStore"));
        return $t;
    }
	...
	public function getRealFile(){
		if(!isset($this->realFilePointer)){
			...
			if($isRemote){
				register_shutdown_function(array("BoA\Core\Utils\Utils", "silentUnlink"), $this->realFilePointer);
			}
		}
