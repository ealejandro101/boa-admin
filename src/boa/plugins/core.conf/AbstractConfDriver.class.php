	...
	function switchAction($action, $httpVars, $fileVars)
	{
		...
		switch ($action){			
			...
			case "switch_repository":
				...
				Logger::logAction("Switch Repository", array("rep. id"=>$repository_id));
			...
			case "get_bookmarks":
				...
				XMLWriter::header();
				XMLWriter::writeBookmarks($bmUser->getBookmarks());
				XMLWriter::close();
				exit(1);
            ...
            case "user_create_repository" :
                ...
                if($res == -1){
                    ...
                    XMLWriter::sendMessage($mess[425], null);
            ...
            case "user_delete_repository" :
                ...
                if($res == -1){
                    ...
                    XMLWriter::sendMessage($mess[428], null);
                    XMLWriter::reloadRepositoryList();
                }
                XMLWriter::close();
