...
"create" => "Create",
"mkdco" => "New Object",
"mkdco.title" => "Create/Edit digital content object",
"mkdco.access_key" => "O",
"editdco" => "Edit",
"editdco.title" => "Edit Object Information",
"editdco.access_key" => "E",
...
"local" => "Local",
"dco_externalurl" => "URL",
"dco_externalurl.help" => "External URL to access this object",
"dco_icon" => "Icono",
"dco_status" => "Status",
...
"publish" => "Publish",
"set_entry_point" => "Set as default file",
"set_entry_point_confirmation" => "[FILE] will be assigned as the default file. ¿Do you want to continue?",
