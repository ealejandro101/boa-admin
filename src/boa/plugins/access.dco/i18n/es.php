...
"create" => "Crear",
"mkdco" => "Nuevo objeto",
"mkdco.title" => "Crear/Editar objeto de contenido digital",
"mkdco.access_key" => "o",
"editdco" => "Editar",
"editdco.title" => "Editar información del objeto",
...
"local" => "Local",
"dco_externalurl" => "URL",
"dco_externalurl.help" => "URL external para acceder al objeto",
"dco_icon" => "Icono",
"dco_status" => "Estado",
