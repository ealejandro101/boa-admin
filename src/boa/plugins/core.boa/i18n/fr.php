...
"23" => "Fichier",
"24" => "Dossier parent",
"25" => "Transférer un ou plusieurs fichiers (max ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") dans : ",
...
"369" => "Raccourci",
"370" => "Téléchargement public [Application]",
...
"390" => "Code",
"391" => "Pas de dépôt",
"392" => "Attention, la version de [Application] (%s) a changé, merci de vider votre cache et rafraichir la page.",
...
"404" => "WebDAV est un protocole permettant de 'monter' vos espaces de travail [Application] comme des disques durs réseaux, directement sur votre bureau. Pour activer cette fonctionnalité, cochez la case et entrez un mot de passe s'il vous est demandé.",
