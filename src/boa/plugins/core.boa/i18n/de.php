...
"23" => "Datei",
"24" => "Aufwärts",
"25" => "Eine oder mehrere Dateien (max. ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") in folgendes Verzeichnis hochladen: ",
...
"165"=> "Einstellungen",
"166"=> "Info",
"167"=> "Über [Application]",
"168" => "Anmelden",
"169" => "[Application] verlassen",
...
"370" => "[Application] Öffentlicher Download",
...
"390" => "Code",
"391" => "Kein Repository",
"392" => "Achtung, die Version des Applikation hat sich geändert (jetzt %s). Bitte den Browser-Cache leeren und die Seite neu laden!",
...
"404" => "Das WebDAV-Protokoll kann verwendet werden, um die Applikation Repositories als 'Netzwerklaufwerk' unter Windows, Mac, iPhone usw. zu nutzen.",
