...
"23" => "Αρχείο",
"24" => "Πίσω",
"25" => "Φορτώστε ένα ή περισσότερα αρχεία (max. ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") στον φάκελο : ",
...
"166"=> "Σχετικά",
"167"=> "Σχετικά...",
"168" => "Σύνδεση στο [Application]",
"169" => "Αποσύνδεση απο το [Application]",
"170" => "Τρέχων Φάκελος",
"parent_access_key" => "Π",
