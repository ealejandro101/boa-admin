...
"Try to use the current System user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!" => "Try to use the current System user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!",
"User name" => "User name",
...
"Prefilled label for the new repository, you can use the BOA_USER keyworkd in it." => "Prefilled label for the new workspace, you can use the BOA_USER keyworkd in it.",
