...
"Main container for core System settings (application title, sharing, webdav server config, etc...)" => "Main container for core System settings (application title, sharing, webdav server config, etc...)",
...
"If not inferred directly from the current URI plus the public download folder name, replace the public access URL here." => "If not inferred directly from the current URI plus the public download folder name, replace the public access URL here.",
...
"Use framework via the command line, allowing CRONTAB jobs or background actions." => "Use framework via the command line, allowing CRONTAB jobs or background actions.",
...
"Try to use the current System user credentials for connecting. Warning, the APP_SESSION_SET_CREDENTIALS config must be set to true!" => "Try to use the current System user credentials for connecting. Warning, the APP_SESSION_SET_CREDENTIALS config must be set to true!",
"User name" => "User name",
...
"Prefilled label for the new repository, you can use the APP_USER keyworkd in it." => "Prefilled label for the new workspace, you can use the APP_USER keyworkd in it.",
