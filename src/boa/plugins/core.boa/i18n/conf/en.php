...
"Try to use the current AjaXplorer user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!" => "Try to use the current AjaXplorer user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!",
"User name" => "User name",
