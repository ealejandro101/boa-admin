...
"Try to use the current System user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!" => "Utilisation des identifiants de la session, entrés via le formulaire de login. 'Set Session Credentials' doit être activé dans les préférences générales d'[Application].",
...
"Prefilled label for the new repository, you can use the BOA_USER keyworkd in it." => "Libellé prérempli pour le nouveau dépôt, vous pouvez utiliser BOA_USER.",
