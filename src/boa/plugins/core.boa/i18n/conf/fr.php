...
"Try to use the current AjaXplorer user credentials for connecting. Warning, the BOA_SESSION_SET_CREDENTIALS config must be set to true!" => "Utilisation des identifiants de la session, entrés via le formulaire de login. 'Set Session Credentials' doit être activé dans les préférences générales d'AjaXplorer.",
