...
"23" => "Файл",
"24" => "На уровень выше",
"25" => "Загрузить один или несколько файлов (максимум ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") в папку: ",
...
"166"=> "О программе",
"167"=> "Об [Application]",
"168" => "Подключиться к [Application]",
"169" => "Отключиться от [Application]",
"170" => "Текущая папка",
"parent_access_key" => "В",
