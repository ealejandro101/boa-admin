...
"390" => "Code",
"391" => "No Repository",
"392" => "Warning, Plaftorm version has changed (now %s), please clear your browser cache and refresh the page to be sure that everything is functionnal!",
...
"404" => "WebDAV is a protocol that allows you to mount your workspaces as a 'network drive' directly on your desktop. To enable this feature, please check the box below, and enter your password if necessary.",
