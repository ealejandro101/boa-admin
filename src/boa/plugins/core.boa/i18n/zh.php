...
"23" => "文件",
"24" => "上一级目录",
"25" => "上传一个或多个文件 (最多 ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER')." 个) 到目录: ",
"26" => "创建新目录于 : ",
"27" => "上传(U)",
"28" => "创建新文件于 : ",
"29" => "创建",
...
"390" => "代码",
"391" => "无存储库",
"392" => "警告，[Application] 版本已更改(现在为 %s)，请清除您的浏览器缓存并刷新页面，以确保一切运行正常!",
