...
"23" => "Soubor",
"24" => "Nadřazená složka",
"25" => "Nahrát jeden nebo více souborů (max. ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") do složky : ",
...
"166"=> "O aplikaci",
"167"=> "O [Application]u",
"168" => "Připojit se k [Application]u",
"169" => "Odpojit se od [Application]u",
"170" => "Aktuální složka",
"parent_access_key" => "d",
