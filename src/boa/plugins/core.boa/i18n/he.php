...
"23" => "קובץ",
"24" => "Parent directory",
"25" => "Upload one or more files (max. ".\BoA\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER').") in the directory : ",
"26" => "צור ספריה חדשה ב: ",
"27" => "העלה קובץ",
"28" => "צור קובץ חדש ב : ",
"29" => "צור",
...
"165"=> "הגדרות",
"166"=> "אודות",
"167"=> "אודות [Application]",
"168" => "התחבר ל [Application]",
"169" => "התנתק מ [Application]",
"170" => "תיקיה נוכחית",
"parent_access_key" => "ל",
