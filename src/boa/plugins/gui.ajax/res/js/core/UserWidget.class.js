...
Class.create("UserWidget", {
	...
	updateGui : function(){
		...
		if(oUser != null) 
		{
			if(oUser.id != 'guest') 
			{
				...
				if(!oUser.lock && oUser.getPreference('lang') != null && oUser.getPreference('lang') != "" && oUser.getPreference('lang') != app.currentLanguage)
				{
	...
	updateActions : function(){
		var menuItems = $A();
		var actions = app.actionBar.getActionsForAppWidget("UserWidget", this.element.id);
        var groups = {};
