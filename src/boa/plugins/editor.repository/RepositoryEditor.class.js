...
Class.create("RepositoryEditor", AbstractEditor, {
    ...
    feedMetaSourceForm : function(xmlData, metaPane){
        ...
        this.metaSelector.observe("change", function(){
            ...
            modal.refreshDialogAppearance();
            modal.refreshDialogPosition();
            addFormDetail.insert("<div class='largeButton' style='width:100px;clear:both;margin-top: 7px;margin-left: 0'><img src=\""+ajxpResourcesFolder+"/images/actions/16/filesave.png\"><span class=\"title\">"+MessageHash['repository_editor.11']+"</span></div>");
